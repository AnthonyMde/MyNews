...
public class NewsArticleTest {
    ...
    @Test
    public void Given_DataApi_When_CallApi_Then_GetSectionData() {
        assertEquals("Science", article.getSection());
    }

    @Test
    public void Given_DataApi_When_CallApi_Then_GetSubSectionData() {
        assertEquals("", article.getSubsection());
    }

    @Test
    public void Given_DataApi_When_CallApi_Then_GetAbstract() {
    ...
    @Test
    public void Given_DataApi_When_CallApi_Then_GetPublishedDate() {
        assertEquals("2018-09-17T13:18:27-04:00", article.getPublishedDate());
    }

    /* From TopStories */
    @Test
    public void Given_DataApi_When_CallApi_Then_GetMultimedia() {
    ...
    /* From TopStories API */
    @Test
    public void Given_DataApi_When_CallApi_Then_GetMultimediaUrl() {
