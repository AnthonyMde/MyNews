...
public class HealthFragment extends Fragment implements ArticleCalls.Callbacks, RecyclerViewAdapter.OnItemClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //NYT api call.
        ArticleCalls.fetchNews(this, Constants.API_KEY, "Health");
    }
    ...
    public void onItemClick(NewsArticle article) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.e("OnItemClick", "Impossible to start the activity "+this.toString());
        }
    }
}
